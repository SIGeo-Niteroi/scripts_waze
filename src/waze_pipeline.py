...
def waze_live():
    try:
        ...
        waze_live_alerts(dfs_api["df_api_alerts"], df_live_alerts_layer, live_alerts_layer)
        waze_live_traffic(dfs_api["df_api_traffic"], df_live_traffic_layer, live_traffic_layer)
